...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text
{
    ...
    CGRect textSize = [text boundingRectWithSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName: font} context:nil];
